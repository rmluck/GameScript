...
func formatPlayoffSeeds(seeds []standings.PlayoffSeed) []map[string]interface{} {
    ...
    for _, seed := range seeds {
        result = append(result, map[string]interface{}{
            ...
            "conference_record": fmt.Sprintf("%d-%d-%d", seed.Team.ConferenceWins, seed.Team.ConferenceLosses, seed.Team.ConferenceTies),
            "division_record": fmt.Sprintf("%d-%d-%d", seed.Team.DivisionWins, seed.Team.DivisionLosses, seed.Team.DivisionTies),
